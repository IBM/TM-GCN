# This version of bitcoin experiment imports data preprocessed in Matlab, and uses a variant of the WD-GCN by Manessi et al. (2019)
...
for tr in range(no_trials):
	for alpha in alpha_vec:
		...
		save_res_fname = "results_WDGCN" + "_w" + str(round(float(class_weights[0])*100)) + "_" + dataset + "_link_prediction"

		# Create gcn for training
		gcn = wgf.WD_GCN(C_train[:-1], X_train[:-1], e_train, [6,2])
