# This version of amlsim experiment imports data preprocessed in Matlab, and uses our TensorGCN
...
# Turn Ct_train, Ct_val and Ct_test into lists of sparse matrices so that we can use them in matrix multiplication...
Ct_train_2 = []
...
target_train = (labels_train!=-1).long() # Untrustworthy edges are 0, all other 1. So 0 is miniority class.
