# This version of uci experiment imports data preprocessed in Matlab, and uses our TensorGCN
...
for tr in range(no_trials):
	for alpha in alpha_vec:
		...
		if loss_type == "softmax":
			...
			n_output_feat = 1	
		if no_layers == 2: 
			gcn = ehf.EmbeddingGCN2(Ct_train_2[:-1], X_train[:-1], e_train, M[:-1, :-1], hidden_feat=[6,6,n_output_feat], condensed_W=True, use_Minv=False, apply_M_twice=True, apply_M_three_times=True, nonlin2="selu") 
		elif no_layers == 1:
